  ...
  return (
    <>
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-6">
          {/* small box */}
          <div className="small-box bg-secondary" style={{borderRadius: '20px'}}>
            <div className="inner">
              <h3>1</h3>
              <p>Close Ticket</p>
            </div>
        ...
        <div className="col-lg-4 col-6">
          {/* small box */}
          <div className="small-box bg-success" style={{borderRadius: '20px'}}>
            <div className="inner">
              <h3>2</h3>
              <p>Resolved Ticket</p>
            </div>
      ...
      <div className="card" style={{borderRadius: '20px'}}>
        <div className="card-header">
          <h2 className="card-title mb-3 mt-2"><b>All Tickets</b></h2>
        </div>
        {/* /.card-header */}
          ...
          <table className="table table-sm">
            ...
            <tbody>
              <tr>
                ...
                <td><span className="badge bg-info">Open</span></td>
                <td>12 Dec 2023</td>
                <td><button onClick={() => setGoToProductListing(true)} type="button" class="btn btn-block bg-gradient-primary btn-sm" style={{width: '80px'}}>View</button></td>
              </tr>
              <tr>
                <td>#00124</td>
                <td>Others</td>
              ...
              <tr>
                <td>#00125</td>
                <td>Others</td>
                <td><span className="badge bg-secondary">Close</span></td>
                <td>11 Nov 2023</td>
                <td><button onClick={() => setGoToProductListing(true)} type="button" class="btn btn-block bg-gradient-primary btn-sm" style={{width: '80px'}}>View</button></td>
              </tr>
              <tr>
