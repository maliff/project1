    ...
    <>
      ...
      <LteContent>
        <div className="card">
            ...
            <h4 className="mb-4"><b>#00123 Product Listing</b><span className="badge bg-info ml-1">Open</span></h4>
            </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="mailbox-read-message">
                                <p>Dear Admin,</p>
                                <p>I need help in adding my current product in the list.<br /> Attached is the proof that the product is not  in the list.</p>
                                <p>Here are the details;</p>
                                <p>Product Category: Electricity <br /> Product Name: Thermal</p>
                                <p>Thanks,<br />Julian C.</p>
                            </div>
                            <ul className="mailbox-attachments d-flex align-items-stretch clearfix">
                            <li>
                            <span className="mailbox-attachment-icon has-img"><img src="./images/Screenshot_123.png" alt="Attachment" /></span>
                                <div className="mailbox-attachment-info">
                                    <a href="#" className="mailbox-attachment-name"><i className="fas fa-camera" /> screenshot_124.png</a>
        ...
        <div className="card-footer bg-white mt-3">
            <h4 className="mb-4"><b>Comment &#40; 0 &#41;</b></h4>
